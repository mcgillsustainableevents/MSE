  ...
  return (
    <Centered>
      <Container text className="complete">
        ...
        <p>
          We are excited that you share our passion and interest in changing the
          culture of event planning at McGill to make events more
          environmentally, economically, and socially sustainable.
        </p>
        <p style={{ fontWeight: 400 }}>We look forward to working with you!</p>
        <Button fluid onClick={() => history.replace('/')}>
          Return to home page
        </Button>
      </Container>
    </Centered>
