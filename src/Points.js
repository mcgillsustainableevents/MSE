...
const certification = score => {
  ...
  if (score < 0.75) return 'This score qualifies your event for a bronze certification, well done!';
  if (score < 0.9) return 'This score qualifies your event for a silver certification, well done!';
...
const Points = ({ pointsNumerator, pointsDenominator }) => (
  <div className="points">
    <Statistic inverted horizontal>
      <Statistic.Value>{`${pointsNumerator}/${pointsDenominator}`}</Statistic.Value>
